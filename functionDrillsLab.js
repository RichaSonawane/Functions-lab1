...
//CODE HERE
const jsNinja = () => {return ("I am javascript ninja") }
let stringNinja = jsNinja();
console.log(stringNinja)
...
//CODE HERE
const greeting = name1 => { return ("Hello "+ name1)}
let greet = greeting("Jake");
console.log(greet);
...
function nameCheck(name){
  if(name==="Steven"){
    ...
    console.log(`Cool naame, ${name}`)
  }
  }
let nameGreeting = nameCheck("mira")
...
//CODE HERE
const bestMovie =title => {return `${title} is best movie ever!`}
...
//CODE HERE
function theEliminator(arr1,loser1){
...
const upString = (str) => {
  ...
  let anyStr = upString(sampleString);
  console.log(anyStr);
...
let verify = emailCheck("richa_ddgmail.com");
console.log(verify);
////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as many chocolate frogs as
   possible with a certain amount of gold. Each chocolate frog costs 3 gold. Your function should take in 
   a single parameter, which is the amount of gold you are willing to spend. Your function should return a 
...
//CODE HERE
function calculate(goldAmount){
  let chocoFrogs =goldAmount/3;
  return chocoFrogs;
}
let totalFrogs = calculate(4);
console.log(totalFrogs);

////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold,
   the function would return to you 1.3333... However, you can't really go to a store and by 
   1.333 products. You would just be able to purchase 1 product. Re-write the function you used 
   in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. 
   Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

//CODE HERE
function calculate2(goldAmount){
   let chocoFrogs = goldAmount / 3;
    return (Math.floor(chocoFrogs));
}
let totalFrogs2 = calculate2(4);
...
/*
  Write a function that takes in an array of numbers as an argument.
   In the body of the function, write logic to determine if the array is in ascending order.
    ...
    Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the 
